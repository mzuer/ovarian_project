...
outfolder = os.path.join('OV_TCGA_NORM_TUM_VAE')
...
input_data = os.path.join('/home', 'marie' ,'Documents', 'FREITAS_LAB', 'VAE_tutos/NeuralDec/ovarian_data/log_filtNormCount_dt.txt')
